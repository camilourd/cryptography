...
public class AESTest extends CryptosystemTest<BitArray[], StateArray, Boolean> {

	public AESTest() {
		super(new AES(128, 283));
	}
	...
	public void encodeDecodeTest() {
		...
		result = cryptosystem.encode(words, state);
		System.out.println("encoding: " + BitArrayTools.toHexString(result.getOutput()));
		assertNotEquals(result.getOutput(), input);
		result = cryptosystem.decode(words, state);
		System.out.println("decoding: " + BitArrayTools.toHexString(result.getOutput()) + "\n");
